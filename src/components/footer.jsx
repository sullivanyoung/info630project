					...
					<div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
						...
						<ul className="text-sm">
							...
							<li className="mb-2">
								<a
									className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out"
									href="https://www.tahzoo.com/about"
									target="_blank"
									rel="noopener noreferrer"
								>
									About Us
							...
							<li className="mb-2">
								<a
									className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out"
									href="https://www.tahzoo.com/careers"
									target="_blank"
									rel="noopener noreferrer"
								>
									Careers
						...
						<ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
							<li>
								<a
									...
									aria-label="Twitter"
									href="https://twitter.com/tahzoo?lang=en"
									target="_blank"
									rel="noopener noreferrer"
								>
									<svg
							...
							<li className="ml-4">
								<a
									...
									href="https://github.com/magroves/tahzoo-internship-react"
									target="_blank"
									rel="noopener noreferrer"
								>
									<svg
